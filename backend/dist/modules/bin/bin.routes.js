...
binRouter.post('/', (0, auth_middleware_1.authorize)('bin.create'), (0, validate_1.validate)(bin_validation_1.createBinSchema), controller.create);
...
binRouter.patch('/:id', (0, auth_middleware_1.authorize)('bin.update'), (0, validate_1.validate)(bin_validation_1.binIdSchema, validate_1.ValidationSource.PARAMS), (0, validate_1.validate)(bin_validation_1.updateBinSchema), controller.update);
binRouter.delete('/:id', (0, auth_middleware_1.authorize)('bin.delete'), controller.delete);
