...
import { ChevronRight, ArrowRight, ShieldCheck, Zap, Layers } from 'lucide-react';
        ...
        <div className="relative rounded-[32px] bg-[#111827] text-white p-8 sm:p-12 lg:p-16 overflow-hidden shadow-2xl shadow-gray-900/20">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white mb-6 leading-tight">
              Ready to transform your warehouse operations with <span className="text-emerald-400">wareX</span>?
            </h2>

            <p className="text-base sm:text-lg text-gray-300 mb-10 max-w-xl mx-auto font-normal leading-relaxed">
              Monitor inventory across locations, assign pick tasks with precision, and scale your logistics effortlessly from one intelligent platform.
            </p>
            ...
            <div className="pt-8 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-gray-400 font-medium">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <span>Multi-Warehouse Visibility</span>
              </div>
            </div>
